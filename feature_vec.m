...
% First Moment
n20=cent_moment1(2,0,A);
n02=cent_moment1(0,2,A);
M1=n20+n02;

% Second Moment
n20=cent_moment1(2,0,A);
n02=cent_moment1(0,2,A);
n11=cent_moment1(1,1,A);
M2=(n20-n02)^2+4*n11^2;

% Third Moment
n30=cent_moment1(3,0,A);
n12=cent_moment1(1,2,A);
n21=cent_moment1(2,1,A);
n03=cent_moment1(0,3,A);
