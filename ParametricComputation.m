...
vertical{1,2} = 'CDP1ICDAR';
vertical{1,3} = '3_LDTWICDAR';
vertical{1,4} = 'SSDTWICDAR';
vertical{1,5} = 'PDTWICDAR';
vertical{1,6} = 'PDDTWICDAR';
vertical{1,7} = '5_LDTWICDAR';
vertical{1,8} = 'Itekura_BandICDAR';
vertical{1,9} = 'DDTWICDAR';

horizontal{1,1} = 'DTWICDAR';
horizontal{1,2} = 'CDP1ICDAR';
horizontal{1,3} = '3_LDTWICDAR';
horizontal{1,4} = 'SSDTWICDAR';
horizontal{1,5} = 'PDTWICDAR';
horizontal{1,6} = 'PDDTWICDAR';
horizontal{1,7} = '5_LDTWICDAR';
horizontal{1,8} = 'Itekura_BandICDAR';
horizontal{1,9} = 'DDTWICDAR';
