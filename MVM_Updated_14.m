function [pathCost,pathTarget,indxcol,indxrow,distSum,jumpcost] = MVM_Updated_14(refSample,testSample,weight,straight)
pathTarget = 1;
...
if(N == M) 
    ...
    onesMat = ones(noOfSamplesInRefSample,noOfSamplesInTestSample); 
    Dist = onesMat + Dist;
