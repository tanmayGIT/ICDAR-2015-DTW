function resultArr  = matchFeatureOffline(fileNames,refImgName,refImg,technique,normalizeFunc,featureFunc,heightMatter,percent)
imageFilePathRef{1,1} = refImgName;
imageFilePathRef{1,2} = refImg;
nImages = (length(fileNames));
if(ispc)
    pathstr = '.\testOnComponentImage\';
...
%     disp(k);
    distVal = wordSpottingBatchOperationComponentImg(featureMatForImage,realIndexMatForImage,...
        ...
        technique,avgWidth,avgHeight,heightMatter,testImgPath,imageFiePath_1,testName,percent);
