function resultArr  = matchFeatureOffline_ICDAR(keepAllFeature,myGT,technique,percent,temImgRefBin,temImgRefGrey,refname,ncomp)
...
%     flag = 0;
%     for jj = 1:1:size(myGT,1)
%         testGT = myGT{jj,1};
%         nameDig = str2num(testGT(1,9:end));
%         if(testName == nameDig)
%             flag = 1;
%             break;
%         end
